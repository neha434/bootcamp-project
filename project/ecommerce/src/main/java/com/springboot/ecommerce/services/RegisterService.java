...
import com.springboot.ecommerce.exception.CustomerAlreadyExistsException;
import com.springboot.ecommerce.exception.SellerAlreadyExistsException;
...
public class RegisterService {
    ...
    public void setRegisteredSellerAddress(SellerCO sellerCO, Integer id) {
        ...
        if(sellerOptional.isPresent()) {
            address.setUser(sellerOptional.get());
        }
