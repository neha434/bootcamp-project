...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/address/view","/customer/viewProfile","/customer/update","/address/{id}","/address/Add","/order/","view-myProduct/{id}","/customer/changePassword","/address/Customer{id}","/address/delete/{id}").hasAnyRole("CUSTOMER","ADMIN")
                .antMatchers("/add-product-variation/{productId}","seller/update/{id}","/seller/address/{id}","/add-product","/get-product-list","/get-product/{productId}","/update-product/{productId}","/delete/{productId}","/changePassword","/update-productVariation/{productVariationId}","/seller/viewProfile","/seller/update","/get-productVariation/{productVariationId}").hasAnyRole("SELLER","ADMIN")
