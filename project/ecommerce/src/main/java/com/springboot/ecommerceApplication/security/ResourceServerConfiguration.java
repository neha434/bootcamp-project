...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/product/","/customer/delete/{id}","/seller/","/customer/","/activate/{id}","/deactivate/{id}","/changeRole/{role}/{id}","/updateAdmin/{id}","/activateProduct/{id}","/category/add","/category/{categoryId}","/category/list","/category/update/{categoryId}","/MetadataField/add","/MetadataField/list","/metadataFieldValues/add","/metadataFieldValues/update/{metadataValueId}").hasAnyRole("ADMIN")
