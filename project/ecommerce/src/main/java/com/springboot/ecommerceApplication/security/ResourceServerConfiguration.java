...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/add-product-variation/{productId}/{price}/{quantity}","seller/update/{id}","/seller/address/{id}","/add-product","/get-product-list","/get-product/{productId}","/update-product/{productId}","/delete/{productId}","/changePassword","/update-productVariation/{productVariationId}").hasAnyRole("SELLER","ADMIN")
